...
/**
 * Error code server returns for no error.
 */
const NO_ERROR = 1;
...
/**
 * Query server and get information of a specific product.
 * @param int productId ID of the product to search.
 * @return A promise that will be resolved with a product model.
 * If wrong Id provided, it will contain null.
 */
